...
private static void PrintConfigSummary(EffectiveConfig c)
{
    ...
    bool isDiscordSet = !string.IsNullOrWhiteSpace(_environmentConfig.DiscordWebhook);
...
private static bool IsInteractive()
{
    ...
    private static async Task SendDiscordAsync(string message)
    {
        if (string.IsNullOrWhiteSpace(_environmentConfig.DiscordWebhook))
        {
        ...
        try
        {
            ...
            using var resp = await http.PostAsync(_environmentConfig.DiscordWebhook,
